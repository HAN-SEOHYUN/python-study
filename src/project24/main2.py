...
ff = np.fromfile(r'사진을 그림으로 변환하기 (OpenCV/여행사진.jpg', np.uint8)
...
while True:
    ...
    cartoon_img = cv2.stylization(img, sigma_s_value, sigma_r=sigma_r_value)
